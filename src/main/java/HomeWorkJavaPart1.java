public class HomeWorkJavaPart1 {
...
//        byte minByteOverflow = -128 - 1; //not compiled
//        byte maxByteOverflow = 127 + 1; //not compiled
//        short minShortOverflow = Short.MIN_VALUE - 1; //not compiled
//        short maxShortOverflow = Short.MAX_VALUE + 1; //not compiled
